...
public class Player4Bullet : MonoBehaviour {
	...
	void Start() {
		...
		speedX = Mathf.Sin(MyGlobalAngleController4.SharedInstance.JoyAngle);
		speedY = Mathf.Cos(MyGlobalAngleController4.SharedInstance.JoyAngle);
		transform.localEulerAngles = new Vector3 (0,0,MyGlobalAngleController4.SharedInstance.JoyAngle/Mathf.PI*-180);
