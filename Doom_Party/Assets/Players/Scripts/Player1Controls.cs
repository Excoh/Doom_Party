...
public class Player1Controls : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (Input.GetKey("joystick 1 button 0") | Input.GetKey("c"))
        { //change c to right mouse click
        ...
        if (MyGlobalController.SharedInstance.Mode == 0)
        {
            ...
            if (MyGlobalController.SharedInstance.Mode == 2)
            { //sprint
    ...
    void OnCollisionEnter2D(Collision2D col)
    {
        ...
        if (col.gameObject.tag == "Enemy")
        {
            ...
            if (P1Health <= 0)
            {
                ...
                HealthManager.player1dead = true;
                Destroy(gameObject);
            }
